    ...
    <div class="space-y-6">
        @if (Gate::check('addTenantEmployee', $tenant))
            ...
            <x-filament-tenants::grid-section md="2">
                ...
                <x-filament::section>
                    <form wire:submit="addTenantEmployee" class="fi-sc-form">
                        ...
                        @if (count($this->roles) > 0)
                            <x-filament-forms::field-wrapper id="role" statePath="role" required="required" label="{{ __('filament-tenants::default.labels.role') }}">
                                <div x-data="{ role: $wire.entangle('addTenantEmployeeForm.role') }" class="relative z-0 mt-1 cursor-pointer rounded-lg border border-gray-200 dark:border-gray-700">

...
return [
    ...
    'errors' => [
        'cannot_leave_tenant' => 'You may not leave a tenant that you created.',
        'tenant_deletion' => 'You may not delete your personal tenant.',
        ...
        'employee_already_belongs_to_tenant' => 'This employee already belongs to the tenant.',
        'employee_already_invited' => 'This employee has already been invited to the tenant.',
        ...
        'user_belongs_to_tenant' => 'This user already belongs to the tenant.',
    ...
    'banner' => [
        'tenant_invitation_accepted' => 'Great! You have accepted the invitation to join **:tenant**.',
    ],
    ...
    'notifications' => [
        ...
        'tenant_created' => [
            ...
            'body' => 'A new tenant has been created with the name **:name**.',
        ],

        'tenant_deleted' => [
            'title' => 'Tenant deleted',
            'body' => 'The tenant **:name** has been deleted.',
        ],
        ...
        'tenant_name_updated' => [
            ...
            'body' => 'Your tenant name has been updated to **:name**.',
        ],
    ...
    'grid_section_titles' => [
        'add_tenant_employee' => 'Add Tenant Employee',
    ...
    'grid_section_descriptions' => [
        'add_tenant_employee' => 'Add a new tenant employee to your tenant, allowing them to collaborate with you.',
        'browser_sessions' => 'Manage and log out your active sessions on other browsers and devices.',
        'tenant_name' => "The tenant's name and owner information.",
    ...
    'action_section_titles' => [
        'tenant_employees' => 'Tenant Employees',
        'connected_accounts' => 'Connected Accounts',
        'delete_tenant' => 'Delete Tenant',
        'pending_tenant_invitations' => 'Pending Tenant Invitations',
    ],

    'action_section_descriptions' => [
        'tenant_employees' => 'All of the people that are part of this tenant.',
        'connected_accounts' => 'Manage and remove your connected accounts.',
        'delete_tenant' => 'Permanently delete this tenant.',
        'pending_tenant_invitations' => 'These people have been invited to your tenant and have been sent an invitation email. They may join the tenant by accepting the email invitation.',
    ],
    ...
    'modal_titles' => [
        ...
        'remove_tenant_employee' => 'Remove Tenant Employee',
        'remove_connected_account' => 'Remove Connected Account',
    ...
    'modal_descriptions' => [
        ...
        'delete_tenant' => 'Are you sure you want to delete this tenant?',
        'leave_tenant' => 'Are you sure you would like to leave this tenant?',
        'logout_browser_sessions' => 'Please enter your password to confirm you would like to log out of your other browser sessions.',
        'remove_tenant_employee' => 'Are you sure you would like to remove this person from the tenant?',
    ...
    'subheadings' => [
        ...
        'tenants' => [
            'tenant_employee_manager' => 'Please provide the email address of the person you would like to add to this tenant.',
            'delete_tenant' => 'Once a tenant is deleted, all of its resources and data will be permanently deleted. Before deleting this tenant, please download any data or information regarding this tenant that you wish to retain.',
        ],
    ],

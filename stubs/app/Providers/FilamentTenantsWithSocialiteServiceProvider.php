...
use App\Actions\FilamentTenants\CreateConnectedAccount;
use App\Actions\FilamentTenants\CreateNewUser;
use App\Actions\FilamentTenants\CreateUserFromProvider;
use App\Actions\FilamentTenants\DeleteTenant;
use App\Actions\FilamentTenants\DeleteUser;
use App\Actions\FilamentTenants\HandleInvalidState;
use App\Actions\FilamentTenants\InviteTenantEmployee;
use App\Actions\FilamentTenants\RemoveTenantEmployee;
use App\Actions\FilamentTenants\ResolveSocialiteUser;
use App\Actions\FilamentTenants\SetUserPassword;
use App\Actions\FilamentTenants\UpdateTenantName;
use App\Actions\FilamentTenants\UpdateConnectedAccount;
...
use Wallo\FilamentTenants\Actions\GenerateRedirectForProvider;
...
class FilamentTenantsServiceProvider extends PanelProvider
{
    ...
    public function boot(): void
    {
        ...
        FilamentTenants::resolvesSocialiteUsersUsing(ResolveSocialiteUser::class);
        FilamentTenants::createUsersFromProviderUsing(CreateUserFromProvider::class);
        FilamentTenants::createConnectedAccountsUsing(CreateConnectedAccount::class);
        FilamentTenants::updateConnectedAccountsUsing(UpdateConnectedAccount::class);
        FilamentTenants::setUserPasswordsUsing(SetUserPassword::class);
        FilamentTenants::handlesInvalidStateUsing(HandleInvalidState::class);
        FilamentTenants::generatesProvidersRedirectsUsing(GenerateRedirectForProvider::class);
    }

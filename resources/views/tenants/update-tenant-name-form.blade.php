<x-filament-tenants::grid-section>
    ...
    <x-filament::section>
        <form wire:submit="updateTenantName" class="fi-sc-form">
            ...
            <!-- Tenant Name -->
            <x-filament-forms::field-wrapper id="name" state-path="name" required label="{{ __('filament-tenants::default.labels.tenant_name') }}">
